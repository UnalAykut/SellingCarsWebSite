...
<?php
		...
		if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $stmt = $conn->prepare("INSERT INTO yorumlar (adSoyad, yorum, rating) VALUES (?, ?, ?)");
...
<header class="header" style="background-color:#181818;">
    ...
    <nav class="navbar">
        ...
        <a href="motorsat.php">Motosiklet</a> 
          ...
          <li class=""><a href="yorum1.php">İncelemeler</a></li>
          <li class=""><a href="iletisim.html">İletişim</a></li>
          <li class="active"><a href="hakkimizda1.html">Hakkımızda</a></li>

...
<html>
<head>
    <title>Motorsiklet Düzenle</title>
...
<body style="background-color: black">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-6">
                <h2 class="text-center">Motorsiklet Düzenle</h2>
                <?php
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    ...
                    // Veriyi güncelle
                    $sql = "UPDATE motorlar SET name='$name', image='$image', price='$price', year='$year', transmission='$transmission', fuel='$fuel', top_speed='$top_speed', engine_displacement='$engine_displacement', horsepower='$horsepower', max_torque='$max_torque', average_consumption='$average_consumption', acceleration='$acceleration' WHERE id='$id'";
                ...
                $sql = "SELECT * FROM motorlar WHERE id='$id'";

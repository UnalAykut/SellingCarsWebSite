...
if ($conn->query($sql) === TRUE) {
    ...
    echo '<script>alert("Araba başarıyla silindi."); window.location.href = "admin.php";</script>';
} else {
    // Araba silme hatası, JavaScript ile bir alert mesajı göster
    echo '<script>alert("Araba silme hatası: ' . $conn->error . '"); window.location.href = "admin.php";</script>';
}

...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO motorlar (name, price, year, transmission, fuel, top_speed, engine_displacement, horsepower, max_torque, average_consumption, acceleration, is_favorite, image) 
...
<body>
    <div class="container">
        <h2 class="text-center">Motorsiklet Ekle</h2>
